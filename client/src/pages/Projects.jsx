...
// import { Delete, Edit, Add, RocketLaunch } from "@mui/icons-material";
    ...
    >
      ...
      >
        ...
        <Box>
          ...
          >
            <Chip
              ...
              size="small"
            />
            <IconButton onClick={() => onDelete(project._id)} size="small">
              <Delete fontSize="small" />
            </IconButton>
          </Stack>
        ...
        <Box>
          ...
          <Box sx={{ mb: 2, maxHeight: 70, overflowY: "auto" }}>
      ...
      <CardActions sx={{ justifyContent: "space-between" }}>
        ...
        <Button startIcon={<Edit />} onClick={() => onEdit(project)}>
          Edit
        </Button>
      </CardActions>
    </Card>
